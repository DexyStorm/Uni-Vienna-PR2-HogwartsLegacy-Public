...
public class Scroll extends MagicItem {
	...
	public Scroll(String name, int usages, int price, int weight, Spell spell) 
	{
		...
		if(spell == null)
		{
			throw new IllegalArgumentException("spell must not be null. error thrown from Scroll class from ctor");
		}
		this.spell = spell;
	}
	...
	public void useOn(MagicEffectRealization target) 
	{
		if(target == null)
		{
			throw new IllegalArgumentException("target must not be null. error thrown from class Scroll from 'public void useOn(MagicEffectRealization target)'");
		}
