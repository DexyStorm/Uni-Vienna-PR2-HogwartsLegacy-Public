...
public interface MagicEffectRealization {
	...
	default void takeDamage(int amount) 
	{
		if(amount < 0)
		{
			throw new IllegalArgumentException("amount must not be negative. error thrown from interface MagicEffectRealization from 'default void takeDamage(int amount)'");
		}
	...
	default void takeDamagePercent(int percentage) 
	{
		if(percentage > 100)
		{
			throw new IllegalArgumentException("percentage must be under 100. error thrown from interface MagicEffectRealization from 'default void takeDamagePercent(int percentage)'");
		}
		if(percentage < 0)
		{
			throw new IllegalArgumentException("percentage must not be negative. error thrown from interface MagicEffectRealization from 'default void takeDamagePercent(int percentage)'");
		}
	}
	...
	default void weakenMagic(int amount) 
	{
		if(amount < 0)
		{
			throw new IllegalArgumentException("amount must not be negative. error thrown from interface MagicEffectRealization from 'default void weakenMagic(int amount)'");
		}
	}
	...
	default void weakenMagicPercent(int percentage)
	{
		if(percentage > 100)
		{
			throw new IllegalArgumentException("percentage must be under 100. error thrown from interface MagicEffectRealization from 'default void weakenMagicPercent(int percentage)'");
		}
		if(percentage < 0)
		{
			throw new IllegalArgumentException("percentage must not be negative. error thrown from interface MagicEffectRealization from 'default void weakenMagicPercent(int percentage)'");
		}
	}
	...
	default void heal(int amount)
	{
		if(amount < 0)
		{
			throw new IllegalArgumentException("amount must not be negative. error thrown from interface MagicEffectRealization from 'default void heal(int amount)'");
		}
	}
	...
	default void healPercent(int percentage)
	{
		if(percentage > 100)
		{
			throw new IllegalArgumentException("percentage must be under 100. error thrown from interface MagicEffectRealization from 'default void healPercent(int percentage)'");
		}
		if(percentage < 0)
		{
			throw new IllegalArgumentException("percentage must not be negative. error thrown from interface MagicEffectRealization from 'default void healPercent(int percentage)'");
		}
	}
	...
	default void enforceMagic(int amount)
	{
		if(amount < 0)
		{
			throw new IllegalArgumentException("amount must not be negative. error thrown from interface MagicEffectRealization from 'default void enforceMagic(int amount)'");
		}
	}
	...
	default void enforceMagicPercent(int percentage)
	{
		if(percentage > 100)
		{
			throw new IllegalArgumentException("percentage must be under 100. error thrown from interface MagicEffectRealization from 'default void enforceMagicPercent(int percentage)'");
		}
		if(percentage < 0)
		{
			throw new IllegalArgumentException("percentage must not be negative. error thrown from interface MagicEffectRealization from 'default void enforceMagicPercent(int percentage)'");
		}
	}
	...
	default boolean isProtected(Spell s) 
	{
		if(s == null)
		{
			throw new IllegalArgumentException("s must not be null. error thrown from interface MagicEffectRealization from 'default boolean isProtected(Spell s)'");
		}
	...
	default void setProtection(Set<AttackingSpell> attacks)
	{
		if(attacks == null)
		{
			throw new IllegalArgumentException("attacks must not be null. error thrown from interface MagicEffectRealization from 'default void setProtection(Set<AttackingSpell> attacks)'");
		}
	}
	...
	default void removeProtection(Set<AttackingSpell> attacks)
	{
		if(attacks == null)
		{
			throw new IllegalArgumentException("attacks must not be null. error thrown from interface MagicEffectRealization from 'default void removeProtection(Set<AttackingSpell> attacks)'");
		}
	}
}